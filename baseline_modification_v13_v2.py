...
class TCNWrapper:
    def __init__(self, input_size, seq_len=1, hidden_size=128, num_layers=2, num_symbols=1, dropout=0.2, batch_size=32,
        ...
        self.loss_fn = torch.nn.MSELoss(reduction='none')  # 使用 'none'
    ...
    def fit(self, X_train, y_train, symbol_id_train, X_valid=None, y_valid=None, symbol_id_valid=None,
        ...
        if X_valid is not None and y_valid is not None:
            ...
            X_valid_reshaped, y_valid, symbol_id_valid_tensor = None, None, None
    ...
    def predict(self, X_test, symbol_id_test):
        ...
        X_test_df = pd.DataFrame(X_test_flat, columns=[f"feature_{i:02d}" for i in range(self.input_size)])
...
def get_fold_predictions(model_names, test_df, feature_names_tcn, feature_names_other, symbol_id_to_index, sequence_length):
